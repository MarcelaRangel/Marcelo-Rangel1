...
<div class="container"> <!-- crio o container para comportar todas as divs-->
	<div class="row"><!-- crio uma linha para os botoes onde todos os botoes ficam alinhados-->
		...
		<a href="addprodt.php" class="btn-floating btn-large waves-effect waves-light black"><i class="material-icons">add</i></a><!-- Os botoes onde "ADD" é o nome do icone dentro do botão-->
